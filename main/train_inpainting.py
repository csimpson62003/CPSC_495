...
from .pixel_pattern_dataset import PixelPatternDataset
...
def train_inpainting(
    ...
    # Use pixel pattern dataset instead of CIFAR-10
    print("🎨 Creating pixel pattern dataset for inpainting training...")
    train_dataset = PixelPatternDataset(
        size=max_dataset_size or 20000,  # 20k patterns per epoch
